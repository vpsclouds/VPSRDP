echo Author: HuyGK
echo Website: DoGiTot.Com
@echo off
title Azure-Auto-Region

echo Tải xuống các tệp quan trọng...
curl --silent -O https://raw.githubusercontent.com/vpsclouds/VPSRDP/main/ngrok.exe
curl --silent -O https://raw.githubusercontent.com/vpsclouds/VPSRDP/main/NGROK-CHECK.bat


echo sao chép NGROK vào System32...
